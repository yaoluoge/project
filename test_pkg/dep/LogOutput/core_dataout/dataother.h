...
public:
    ...
    static void toPrint(const QPixmap &pixmap, qreal ratio = 1.0, const QString &fileName = QString());
    //打印控件
    static void widgetToPrint(QWidget *widget, qreal ratio = 1.0);
    //打印图片文件
    static void imageToPrint(const QString &imageFile, qreal ratio = 1.0);
    //打印图表控件
    static void chartToPrint(qreal ratio = 1.0, int width = 400, int height = 300);
